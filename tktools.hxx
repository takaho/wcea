#ifndef SILLYTOOLS_HXX
#define SILLYTOOLS_HXX
#include <vector>
#include <string>
#include <stdexcept>
#include <cstdio>
...
namespace tktools {
    ...
    namespace bio {
        ...
        public:
            fasta_sequence( const char* filename ) throw (exception);
            ~fasta_sequence();
        ...
        fasta_sequence* load_fasta_sequence( const char* filename ) throw ( std::exception );
